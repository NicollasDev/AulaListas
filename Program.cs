...
namespace Aula23Listas
{
    class Program
    {
        static void Main(string[] args)
        {
          ...
          produtos.Add ( new Produto(3, "Microondas", 6800.90f) );
          produtos.Add ( new Produto(4, "Fogão Eletrolux", 6800.90f) );
          ...
          //Podemos enconntrar um poduto específico utilizando Lambda
